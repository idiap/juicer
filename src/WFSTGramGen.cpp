...
Juicer::WFSTNGramStateManager::WFSTNGramStateManager( DecVocabulary *vocab_ )
{
    vocab = vocab_ ;
...
Juicer::WFSTNGramStateManager::~WFSTNGramStateManager()
{
...
int Juicer::WFSTNGramStateManager::getWFSTState(
...
int Juicer::WFSTNGramStateManager::lookupWFSTState( int nWords , int *words )
{
...
int Juicer::WFSTNGramStateManager::getInitState()
{
    if ( initState < 0 )
...
int Juicer::WFSTNGramStateManager::getNode( int parentNode , int word , bool addNew )
{
    int node=-1 ;
...
int Juicer::WFSTNGramStateManager::allocNode( int word )
{
...
void Juicer::WFSTNGramStateManager::initNode( int ind )
{
...
void Juicer::WFSTNGramStateManager::outputText()
{
...
void Juicer::WFSTNGramStateManager::outputNode( int node , int *nWords , int *words )
{
    if ( node < 0 )
        return ;
...
void Juicer::WFSTNGramStateManager::outputNonAccessible()
{
    int *words = new int[30] ;
    int nWords=0 ;
...
void Juicer::WFSTNGramStateManager::outputNonAccessibleNode( int node , int *nWords , int *words )
{
    if ( node < 0 )
        return ;
...
Juicer::WFSTGramGen::WFSTGramGen(
...
void Juicer::WFSTGramGen::writeFSM(
...
void Juicer::WFSTGramGen::writeFSMWordLoop( FILE *fsmFD )
{
...
void Juicer::WFSTGramGen::writeFSMSilWordLoopSil( FILE *fsmFD )
{
...
void Juicer::WFSTGramGen::writeFSMARPA(
...
void Juicer::WFSTGramGen::addDefaultBackoffPath(
...
void Juicer::WFSTGramGen::writeFSMWordPair( FILE *fsmFD )
{
