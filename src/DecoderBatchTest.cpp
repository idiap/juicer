...
void DecoderBatchTest::activateLatticeGeneration( const char *latticeDir_ )
{
   if ( latticeDir_ == NULL )
...
void DecoderBatchTest::openOutputFile()
{
...
void DecoderBatchTest::closeOutputFile()
{
	if ( outputFD == NULL )
		return ;
...
void DecoderBatchTest::outputResult( DecoderSingleTest *test )
{
	if ( outputFD == NULL )
...
void DecoderBatchTest::outputResultPhones( DecoderSingleTest *test )
{
	if ( outputFD == NULL )
...
void DecoderBatchTest::outputWFSTLattice( DecoderSingleTest *test )
{
#ifdef DEBUG
...
void DecoderBatchTest::configureTests()
{    
