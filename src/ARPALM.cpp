...
Juicer::ARPALM::ARPALM( DecVocabulary *vocab_ )
{
    vocab = vocab_ ;
    order = 0 ;
    entries = NULL ;
...
Juicer::ARPALM::ARPALM( const char *arpa_fname , DecVocabulary *vocab_ ,
                        const char *unk_wrd_ )
{
    FILE *fd ;
    int hdr ;
...
void Juicer::ARPALM::writeBinary( const char *fname )
{
    FILE *fd ;
    int i , j , ind , hdr ;
...
void Juicer::ARPALM::readBinary( const char *fname )
{
    FILE *fd ;
    char *tmp ;
    int i , j , hdr , ind ;
...
void Juicer::ARPALM::allocateEntries()
{
...
void Juicer::ARPALM::calcUnkWords()
{
...
void Juicer::ARPALM::printWarning()
{
    vocab->outputText() ;
...
void Juicer::ARPALM::readARPA( const char *arpa_fname )
{
...
real Juicer::ARPALM::RecursiveNormalise(int iLevel, int* iContext, real iBackOff)
{
    assert(iContext);
    assert(iLevel < order);
