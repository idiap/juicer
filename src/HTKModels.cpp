...
int HTKModels::addHMM( HTKHMM *hmm )
{
   ...
   else
   {
    ...
    int t;
    int finalState = curr->nStates-1;
    for (t=1; t< transMats[curr->transMatrixInd].nSucs[0]; t++)
    {
        if (transMats[curr->transMatrixInd].sucs[0][t]  == finalState) {
